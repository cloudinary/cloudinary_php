...
{
    /**
     * @var string The moderation type key.
     */
    const KEY = 'moderation';

    /**
     * @var string Automatically moderate an uploaded image using the Amazon Rekognition AI Moderation add-on.
     *
    ...
    /**
     * @var string Automatically moderate an uploaded asset of any type using the MetaDefender Anti-Malware Protection
     *             add-on.
     *
    ...
    /**
     * @var string Automatically moderate an uploaded image using the WebPurify Image Moderation add-on.
     *
    ...
    /**
     * @var string Add an uploaded asset of any type to a queue of pending assets that can be moderated using the
