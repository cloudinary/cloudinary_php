...
/**
 * Class ParameterMultiValue
 *
 * This class represents a complex value of the cloudinary transformation parameter.
 *
 * @used-by BaseParameter
 */
class ParameterMultiValue extends BaseComponent
{
    /**
    ...
    /**
     * @var int MIN_ARGUMENTS Minimum number of arguments required for the parameter. 0 == all optional.
     */
    const MIN_ARGUMENTS = 0;

    /**
     * @var int MAX_ARGUMENTS Maximum number of arguments allowed for the parameter. 0 == unlimited.
     */
    ...
    /**
     * ParameterMultiValue constructor.
     *
     * @param $arguments
     */
    ...
    public function setArguments(...$arguments)
    {
        ...
        if (static::MIN_ARGUMENTS > count($arguments)) {
            throw new InvalidArgumentException(
                'Parameter "' . static::getName() . '" must have at least ' . static::MIN_ARGUMENTS . ' arguments(s)'
            );
        }

        if (static::MAX_ARGUMENTS !== 0 && count($arguments) > static::MAX_ARGUMENTS) {
            throw new InvalidArgumentException(
                'Parameter "' . static::getName() . '" can have no more than ' . static::MAX_ARGUMENTS . ' arguments(s)'
            );
        }
