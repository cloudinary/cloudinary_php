...
trait TextStyleTrait
{
     ...
     *
     * @param mixed $fontAntialiasing The font antialiasing method.  Use the constants defined in the FontAntialiasing
     *                                class.
     *
     * @return static
     *
     * @see \Cloudinary\Transformation\Argument\Text\FontAntialiasing
     */
    public function fontAntialiasing($fontAntialiasing)
    {
        return $this->setStyleProperty('antialias', $fontAntialiasing, true);
    }
