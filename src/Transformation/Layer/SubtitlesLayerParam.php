...
/**
 * Class SubtitlesLayerParam
 */
class SubtitlesLayerParam extends BaseLayerParam
{
    /**
     * @var string $layerType The type of the layer.
     */
    protected $layerType = 'subtitles';
    ...
    /**
     * SubtitlesLayerParam constructor.
     *
     * @param string|LayerSource|mixed $subtitlesId The public ID of the subtitles asset.
    ...
    public function __construct($subtitlesId, $style = null)
    {
        ...
        $this->subtitlesId($subtitlesId)->style($style);
    }
    ...
    {
        $this->value->setSimpleValue('subtitles_id', $subtitlesId);
