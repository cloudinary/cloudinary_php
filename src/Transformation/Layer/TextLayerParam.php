...
/**
 * Class TextLayerParam
 */
class TextLayerParam extends BaseLayerParam
{
    use TextStyleTrait;
     ...
     */
    protected $layerType = 'text';

    /**
     * @var array $valueOrder The order of the values.
     */
    protected $valueOrder = ['text_style', 'layer_source', 'text'];

    /**
     * TextLayerParam constructor.
     *
     ...
     *
     * @param string|LayerSource $publicId The public ID of the text asset.
     *
     * @return $this
     */
    public function styleFromPublicId($publicId)
    {
        $this->value->setValue(ClassUtils::verifyInstance($publicId, LayerSource::class));
