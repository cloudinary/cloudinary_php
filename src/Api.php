...
namespace Cloudinary {
    ...
    class Api
    {
        ...
        public function resources($options = array())
        {
            ...
            $params = $this->only($options, array(
                "next_cursor",
                "max_results",
                "prefix",
                "tags",
        ...
        public function create_upload_preset($options = array())
        {
            ...
            return $this->call_api(
                "post",
                array("upload_presets"),
                array_merge($params, $this->only($options, array("name", "unsigned", "disallow_public_id"))),
                $options
            );
        }
         ...
         *
         * @param string $name the name of the new profile. if the name is of a predefined profile, the profile will be
         *     modified.
         * @param array $options additional options
         *
         * @return Api\Response
        ...
        {
            $prefix = \Cloudinary::option_get($options, "upload_prefix", \Cloudinary::config_get(
                "upload_prefix",
            ...
            curl_setopt($ch, CURLOPT_PROXY, \Cloudinary::option_get(
                $options,
                "api_proxy",
                \Cloudinary::config_get("api_proxy")
            ));
            ...
            if ($response->responseCode == 200) {
                ...
                if (!$exception_class) throw new \Cloudinary\Api\GeneralError(
        ...
        {
            return is_string($transformation) ? $transformation : \Cloudinary::generate_transformation_string(
                $transformation
            );
        }
