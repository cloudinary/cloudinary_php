...
namespace Cloudinary {
    ...
    class SearchTest extends PHPUnit_Framework_TestCase
    {
        ...
        {
            Curl::mockApi($this);
            $result = $this->search->expression("format:jpg")->max_results(10)->next_cursor("abcd")->sort_by("created_at",
                "asc")->sort_by("updated_at")->aggregate("format")->aggregate("resource_type")->with_field("tags")->with_field("image_metadata")->execute();
