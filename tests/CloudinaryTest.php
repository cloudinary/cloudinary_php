...
class CloudinaryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_http_escape()
    {
        ...
        $this->cloudinary_url_assertion("http://www.youtube.com/watch?v=d9NF2edxy-M", $options, CloudinaryTest::DEFAULT_ROOT_PATH . "image/youtube/http://www.youtube.com/watch%3Fv%3Dd9NF2edxy-M");
    }
    ...
    /**
     * @expectedException InvalidArgumentException
     * @expectedExceptionMessage Must supply either style parameters or a public_id when providing text parameter in a
     *     text overlay
     */
    ...
    public function test_key_should_define_streaming_profile()
    {
        $options = array(
        ...
        $t = Cloudinary::generate_transformation_string($options);
        $this->assertEquals('sp_profile', $t);
    }
