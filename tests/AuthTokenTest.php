...
class AuthTokenTest extends TestCase
{
    ...
    function test_generate_with_start_time_and_duration()
    {
        ...
        $this->assertEquals('__cld_token__=st=1111111111~exp=1111111411~acl=%2fimage%2f%2a~hmac=0d5b0c9c1485ee162c459879fe62e06caa23bc26fec92d58bd100f2e1592eac6',
            $token, $message);
    }
    ...
    function test_should_add_token_if_authToken_is_globally_set_and_signed_is_True()
    {
        ...
        $this->assertEquals("http://test123-res.cloudinary.com/image/authenticated/v1486020273/sample.jpg?__cld_token__=st=11111111~exp=11111411~hmac=8db0d753ee7bbb9e2eaf8698ca3797436ba4c20e31f44527e43b6a6e995cfdb3",
            $url, $message);
    ...
    function test_should_add_token_for_public_resource()
    {
        ...
        $url = \Cloudinary::cloudinary_url("sample.jpg", $options);
        $this->assertEquals("http://test123-res.cloudinary.com/image/public/v1486020273/sample.jpg?__cld_token__=st=11111111~exp=11111411~hmac=c2b77d9f81be6d89b5d0ebc67b671557e88a40bcf03dd4a6997ff4b994ceb80e",
            $url, $message);
    ...
    function test_should_not_add_token_if_signed_is_false()
    {
        ...
        $url = \Cloudinary::cloudinary_url("sample.jpg", $options);
        $this->assertEquals("http://test123-res.cloudinary.com/image/authenticated/v1486020273/sample.jpg", $url,
            $message);
    ...
    function test_null_token()
    {
        ...
        $url = \Cloudinary::cloudinary_url("sample.jpg", $options);
        $this->assertEquals("http://test123-res.cloudinary.com/image/authenticated/s--v2fTPYTu--/v1486020273/sample.jpg",
            $url, $message);
    ...
    function test_explicit_authToken_should_override_global_setting()
    {
        ...
        $url = \Cloudinary::cloudinary_url("sample.jpg", $options);
        $this->assertEquals("http://test123-res.cloudinary.com/image/authenticated/c_scale,w_300/sample.jpg?__cld_token__=st=222222222~exp=222222322~hmac=7d276841d70c4ecbd0708275cd6a82e1f08e47838fbb0bceb2538e06ddfa3029",
            $url, $message);
