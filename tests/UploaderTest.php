...
namespace Cloudinary {
    ...
    class UploaderTest extends \PHPUnit\Framework\TestCase
    {
        ...
        public function test_face_coordinates()
        {
            ...
            $this->assertEquals($info["coordinates"],
        ...
        public function test_context_api()
        {
            ...
            $info = $api->resource($result["public_id"]);
            $this->assertEquals(array("custom" => array("alt" => "testAlt", "custom" => "testCustom")),
                $info["context"]);
        ...
        public function test_cl_form_tag()
        {
            ...
            $form = cl_form_tag("http://callback.com",
...
TAG
        ...
        public function test_cl_image_upload_tag()
        {
            ...
            $this->assertRegExp("#<input class='uploader cloudinary-fileupload' data-cloudinary-field='image' data-form-data='{\"timestamp\":\d+,\"public_id\":\"hello\",\"signature\":\"[0-9a-f]+\",\"api_key\":\"1234\"}' data-url='{$this->url_prefix}\/v1_1\/test123\/auto\/upload' name='file' type='file'\/>#",
                $tag);
        }
        ...
        {
            $response = Uploader::upload(TEST_IMG,
                array("responsive_breakpoints" => array(array("create_derived" => FALSE))));
            $this->assertArrayHasKey("responsive_breakpoints", $response,
